...
from rekounts.sounds import START_CUE, STOP_CUE, AfplayBackend, Sounds
...
def test_windows_preference_is_unchanged(monkeypatch):
    """On non-darwin the chain is still Sine -> Beep -> Null (regression guard:
    the platform split must not have rerouted Windows through afplay)."""
